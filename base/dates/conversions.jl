...
the `DateTime` are used to create the new `Time`. Microsecond and nanoseconds are assumed as zero.
"""
...
Base.convert(::Type{Time},dt::DateTime) = Time(Nanosecond((Dates.value(dt) % 86400000) * 1000000))
"""
